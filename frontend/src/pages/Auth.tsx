...
const Input = ({ label, ...props }: { label: string } & React.InputHTMLAttributes<HTMLInputElement>) => (
  <div className="flex flex-col gap-2 w-full">
    ...
    <input 
      className="w-full bg-gamehub-bg border border-gamehub-muted text-gamehub-text px-4 py-3 rounded focus:border-[#ff79c6] focus:ring-1 focus:ring-[#ff79c6] focus:outline-none transition-all duration-300 font-sans"
      {...props}
    />
  </div>
);
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <motion.div 
          className="bg-gamehub-surface/90 backdrop-blur-md border-2 border-gamehub-purple p-8 sm:p-10 rounded-lg relative overflow-hidden shadow-[0_0_15px_rgba(189,147,249,0.3)]"
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.4 }}
        >
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 bg-gamehub-bg border-2 border-[#ff79c6] rounded-full flex items-center justify-center shadow-[0_0_15px_rgba(255,121,198,0.4)]">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <form className="flex flex-col gap-5" onSubmit={handleSignIn}>
                ...
                {isLogin && (
                  <div className="flex justify-end -mt-1">
                    <a href="#" className="text-xs font-medium text-gamehub-purple hover:text-[#ff79c6] transition-colors tracking-wide">
                      Forgot Password?
                    </a>
                  </div>
                )}
                ...
                <button 
                   type="submit"
                   className="w-full py-4 mt-4 bg-gamehub-purple text-black font-pixel text-[10px] tracking-widest uppercase rounded hover:bg-[#ff79c6] hover:-translate-y-1 transition-all duration-300"
              ...
              <div className="flex items-center gap-4 my-6">
                <div className="flex-1 border-t border-gamehub-muted"></div>
              ...
              <button 
                ...
                className="w-full py-3.5 bg-transparent border-2 border-gamehub-muted text-gamehub-text font-bold tracking-wide text-sm flex items-center justify-center gap-3 rounded hover:border-gamehub-purple hover:bg-gamehub-purple/10 transition-colors duration-300"
              >
                <GoogleIcon />
              ...
              <div className="text-center mt-8 text-gamehub-text text-sm opacity-80">
                ...
                <button 
                  ...
                  className="text-gamehub-purple hover:text-[#ff79c6] hover:underline underline-offset-4 tracking-wide font-bold ml-1 transition-all"
                >
