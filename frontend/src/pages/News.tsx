    ...
    <div className="min-h-screen bg-gamehub-bg text-[var(--text-primary)] p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 text-center flex flex-col items-center">
          <h1 className="text-4xl md:text-5xl font-pixel text-gamehub-purple mb-4 drop-shadow-[0_0_8px_rgba(189,147,249,0.5)] uppercase flex items-center gap-4">
            <Rss className="w-8 h-8 md:w-10 md:h-10 text-gamehub-purple animate-pulse" />
            LATEST TRANSMISSIONS
          </h1>
          <p className="text-gamehub-muted text-sm md:text-base max-w-2xl font-medium tracking-wider mb-2">
            ...
            {games.map((game) => (
              <div key={game.id} className="flex flex-col relative group h-full">
                <div className="relative flex-1">
                  ...
                  {/* New Release Badge */}
                  <div className="absolute top-2 right-2 z-30 bg-[#ffb86c] text-gamehub-bg text-xs font-bold px-2 py-1 rounded-md shadow-[0_0_8px_rgba(255,184,108,0.8)] pointer-events-none">
                    NEW RELEASE
                  </div>
                </div>
                <div className="text-center text-gamehub-muted text-xs mt-3 font-medium tracking-wide">
